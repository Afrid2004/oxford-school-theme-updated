    ...
    <nav class="container header-top bg-light">
      ...
      <div class="header-bottom pt-2 pt-md-0">
        <nav class="navbar navbar-expand-lg sticky-top menubar-bg-color py-0">
          <button class="navbar-toggler d-flex d-lg-none justify-content-between align-items-center w-100" type="button"
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            ...
            <ul class="navbar-nav">
              <li class="nav-item active py-1 bg-danger px-2"><a class="nav-link text-light custom-link"
                  href="<?php esc_url(home_url()); ?>">হোম</a></li>
              <li class="nav-item py-1 bg-info custom-border">
                <div class="dropdown nav-link px-2">
                  <div class="dropdown-toggle text-light" type="button" id="dropdownMenu2" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    আমাদের সম্পর্কে
                  </div>
              ...
              <li class="nav-item py-1 bg-info custom-border"><a class="nav-link text-light px-2" href="./pages/">পিটিএ
                </a></li>
              <li class="nav-item py-1 bg-info custom-border">
                <div class="dropdown nav-link px-2">
                  <div class="dropdown-toggle text-light" type="button" id="dropdownMenu2" data-bs-toggle="dropdown"
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                    <li><a href="./photo-gallery.html" class="dropdown-item nav-link text-light px-3">ফটো গ্যালারি</a>
                    </li>
                    <li><a href="./video-gallery.html" class="dropdown-item nav-link text-light px-3">ভিডিও গ্যালারি</a>
                    </li>
                  </ul>
                </div>
              </li>
