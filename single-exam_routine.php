            ...
            if (have_posts()):
                while (have_posts()):
                    ...
                    <div class="routine-content">
                        ...
                        if ($pdf) { ?>
                            <a href="<?php the_permalink(22); ?>" class="text-white btn bg-info mb-3"><i
                                    class="fa-regular fa-calendar-days"></i> সকল শ্রেণির পরীক্ষার রুটিন দেখুন
                            </a>
                        ...
                        <?php } else { ?>
                            ...
                            <a href="<?php the_permalink(22); ?>" class="text-white btn bg-info"><i
                                    class="fa-regular fa-calendar-days"></i> সকল শ্রেণির পরীক্ষার রুটিন দেখুন
                            </a>
                        <?php }
                        ?>
